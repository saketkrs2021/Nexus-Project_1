...
const email = form.childNodes[5][0];
// const password = form.getElementsByClassName("Password");
const password = form.childNodes[5][1];
// console.log(form.childNodes[5].childNodes);
...
const emailError = form.childNodes[5].childNodes[5];
const passwordError = form.childNodes[5].childNodes[13];
...
const formValidate = (inputEmail, inputPassword) =>{
    ...
    // const emailError = form.childNodes[6];
    // const passwordError = form.childNodes[8];
